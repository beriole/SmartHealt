...
import { Bike, LogOut, UserPen, Phone, Mail, ChevronRight } from 'lucide-react-native';
...
const styles = StyleSheet.create({
  ...
  vehiculeRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 6 },
  section: { gap: 8 },
